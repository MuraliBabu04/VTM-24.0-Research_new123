...
RESULT_DIR="${RESULT_DIR:-$ROOT_DIR/results/Class_B/$SEQUENCE/QP22}"
mkdir -p "$RESULT_DIR"

BITSTREAM="$RESULT_DIR/${SEQUENCE}_QP22.bin"
VTM_LOG="$RESULT_DIR/${SEQUENCE}_QP22_vtm.log"
SPARSITY_CSV="$RESULT_DIR/${SEQUENCE}_QP22_measured_sparsity.csv"
CDSATM_LOG="$RESULT_DIR/${SEQUENCE}_QP22_cdsatm_summary.txt"
RUN_SUMMARY="$RESULT_DIR/${SEQUENCE}_QP22_summary.txt"

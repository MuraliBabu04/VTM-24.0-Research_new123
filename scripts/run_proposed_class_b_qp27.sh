...
RESULT_DIR="${RESULT_DIR:-$ROOT_DIR/results/Class_B/$SEQUENCE/QP27}"
mkdir -p "$RESULT_DIR"

BITSTREAM="$RESULT_DIR/${SEQUENCE}_QP27.bin"
VTM_LOG="$RESULT_DIR/${SEQUENCE}_QP27_vtm.log"
SPARSITY_CSV="$RESULT_DIR/${SEQUENCE}_QP27_measured_sparsity.csv"
CDSATM_LOG="$RESULT_DIR/${SEQUENCE}_QP27_cdsatm_summary.txt"
RUN_SUMMARY="$RESULT_DIR/${SEQUENCE}_QP27_summary.txt"
